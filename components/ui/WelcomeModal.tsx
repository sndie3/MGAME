...
export default function WelcomeModal({ isOpen, onClose }: Props) {
    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
            <div className="w-full max-w-md rounded-xl bg-[var(--primary-color)] p-6 shadow-xl relative text-xs">
                <div className="flex justify-center py-2">
                    <Image
                        ...
                        width={500}
                        height={50}
                        className="rounded-lg w-60 h-25" />
                </div>
                <p className="py-2">The following personalities are <span>NOT ALLOWED</span> to register and/or play in this online gaming website:</p>
                ...
                <p className="py-4">Pinoy MGame <span className="text-[var(--secondary-color)] font-bold">Terms & Condition</span> and <span className="text-[var(--secondary-color)] font-bold">Privacy Policy.</span></p>
                <button
                    onClick={onClose}
                    className="mt-6 w-full rounded-lg bg-[var(--secondary-color)] py-3 text-[var(--primary-color)] font-semibold cursor-pointer"
                >
                    Accept
                </button>
                 <button
